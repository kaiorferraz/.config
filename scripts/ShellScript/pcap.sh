...
gallery="$HOME/pcap/gallery.py"   # path to python gallery script
output="$HOME/pcap/www"           # path to write jpgs
tcpflow="$HOME/pcap/pcap"         # path to where tcpflow is writing
