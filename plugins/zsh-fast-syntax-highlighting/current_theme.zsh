...
: ${FAST_HIGHLIGHT_STYLES[defaultreserved-word]:=fg=magenta}
: ${FAST_HIGHLIGHT_STYLES[defaultalias]:=fg=cyan}
: ${FAST_HIGHLIGHT_STYLES[defaultsuffix-alias]:=fg=green}
: ${FAST_HIGHLIGHT_STYLES[defaultbuiltin]:=fg=magenta}
: ${FAST_HIGHLIGHT_STYLES[defaultfunction]:=fg=magenta}
: ${FAST_HIGHLIGHT_STYLES[defaultcommand]:=fg=magenta}
...
: ${FAST_HIGHLIGHT_STYLES[defaultpath]:=fg=green,underline}
...
: ${FAST_HIGHLIGHT_STYLES[defaultsingle-quoted-argument]:=fg=green}
: ${FAST_HIGHLIGHT_STYLES[defaultdouble-quoted-argument]:=fg=green}
: ${FAST_HIGHLIGHT_STYLES[defaultdollar-quoted-argument]:=fg=green}
: ${FAST_HIGHLIGHT_STYLES[defaultback-or-dollar-double-quoted-argument]:=fg=red}
: ${FAST_HIGHLIGHT_STYLES[defaultback-dollar-quoted-argument]:=fg=red}
...
: ${FAST_HIGHLIGHT_STYLES[defaultfor-loop-variable]:=fg=cyan}
: ${FAST_HIGHLIGHT_STYLES[defaultfor-loop-number]:=fg=magenta}
: ${FAST_HIGHLIGHT_STYLES[defaultfor-loop-operator]:=fg=magenta}
: ${FAST_HIGHLIGHT_STYLES[defaultfor-loop-separator]:=fg=magenta,bold}
...
: ${FAST_HIGHLIGHT_STYLES[defaultcase-condition]:=fg=12}
...
: ${FAST_HIGHLIGHT_STYLES[defaultpath-to-dir]:=fg=green,underline}
...
: ${FAST_HIGHLIGHT_STYLES[defaultsubcommand]:=fg=cyan}
...
: ${FAST_HIGHLIGHT_STYLES[defaultoptarg-string]:=fg=green}
